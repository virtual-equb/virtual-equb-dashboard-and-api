...
<div class="modal fade" id="addMainEqubModal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="post" action="<?php echo e(route('storeMainEqub')); ?>" enctype="multipart/form-data" id="addMainEqub" name="addMainEqub">
...
<?php /**PATH D:\virtual Equb\virtual-backend\resources\views/admin/mainEqub/addMainEqub.blade.php ENDPATH**/ ?>