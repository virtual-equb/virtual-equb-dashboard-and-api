    ...
    <div class="modal fade" id="editMemberModal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <form role="form" method="post" class="form-horizontal form-group" action="" id="updateMember">
...
<?php /**PATH D:\virtual Equb\virtual-backend\resources\views/admin/member/editMember.blade.php ENDPATH**/ ?>