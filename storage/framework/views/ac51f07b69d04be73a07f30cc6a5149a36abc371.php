    ...
    <?php $__env->startSection('content'); ?>
        <div class="content-wrapper">
            ...
            <input type="hidden" id="lable" value="<?php echo e($lables); ?>" />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3><?php echo e($totalMember); ?></h3>
                                    <p>Total Members</p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-bag"></i>
                                </div>
                                <a href="<?php echo e(route('showMember')); ?>" class="small-box-footer">More info <i
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo e(number_format($totalEqubPayment)); ?> ETB</h3>
                                    <p>Summary</p>
                                </div>
                                <div class="icon">
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    <table id="member-list-table" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $tudayPaidMember; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($item->member->full_name); ?></td>
                                                    <td><?php echo e($item->member->phone); ?></td>
                                                    <td><?php echo e($item->member->gender); ?></td>
                                                    <td>Manual</td>
                                            ...
                                            <?php $__currentLoopData = $automaticMembersArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
            ...
            $(function() {
                ...
                var barChartData = {
                    ...
                    datasets: [{
                            ...
                            data: <?php echo e($fullPaidAmount); ?>
                ...
                var summaryChartData = {
                    ...
                    datasets: [{
                            ...
                            pointHighlightFill: '#fff',
                            pointHighlightStroke: 'rgba(60,141,188,1)',
                            data: [<?php echo e($weeklyPaidAmount); ?>, <?php echo e($monthlyPaidAmount); ?>,
                                <?php echo e($yearlyPaidAmount); ?>
                        ...
                        },
                        {
                            ...
                            pointHighlightFill: '#fff',
                            pointHighlightStroke: 'rgba(220,220,220,1)',
                            data: [<?php echo e($weeklyExpected); ?>, <?php echo e($monthlyExpected); ?>, <?php echo e($yearlyExpected); ?>]
                        },
                    ]
                }
                ...
                var pieData = {
                    ...
                    datasets: [{
                        data: [<?php echo e($daylyPaidAmount); ?>, <?php echo e($daylyUnpaidAmount); ?>, <?php echo e($daylyExpected); ?>],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\virtual Equb\virtual-backend\resources\views/admin/home.blade.php ENDPATH**/ ?>