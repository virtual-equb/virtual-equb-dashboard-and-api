    ...
    <?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-two-member"
                                                ...
                                                <?php echo $__env->make('admin/payment.addPayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php echo $__env->make('admin/lottery.addLottery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php echo $__env->make('admin/equb.addEqub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php echo $__env->make('admin/member.addMember', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        ...
                                                        <select class="form-control"id="equbSearchText" name="equb_type_id"
                                                            ...
                                                            <?php $__currentLoopData = $equbTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equbType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option data-info="<?php echo e($equbType->type); ?>"
                                                                    ...
                                                                    <?php echo e($equbType->name); ?> round <?php echo e($equbType->round); ?>
        ...
        <?php echo $__env->make('admin/equb.deleteEqub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/payment.deletePayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/payment.deleteAllPayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/lottery.deleteLottery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/member.editMember', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/member.checkLotteryDate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/equb.editEqub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/notification.sendNotification', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/payment.editPayment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('admin/lottery.editLottery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php $__env->startSection('scripts'); ?>
        <script>
            ...
            function searchForMember(searchInput) {
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-member')); ?>" + '/' + searchInput + '/0',
                        type: 'get',
            ...
            function loadMoreSearchMembers(searchInput, offsetVal, pageNumberVal) {
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-member')); ?>" + '/' + searchInput + '/' +
                            offsetVal + '/' +
                            pageNumberVal,
                        type: 'get',
                        success: function(data) {
            ...
            function searchForStatus(searchInput) {
                ...
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-status')); ?>" + '/' + searchInput + '/0',
                        type: 'get',
                        success: function(data) {
                            $('#member_table_data').html(data);
                            $.LoadingOverlay("hide");
            ...
            function loadMoreSearchStatus(searchInput, offsetVal, pageNumberVal) {
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-status')); ?>" + '/' + searchInput + '/' +
                            offsetVal + '/' +
                            pageNumberVal,
                        type: 'get',
                        success: function(data) {
            ...
            function searchForEqub(searchInput) {
                ...
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-equb')); ?>" + '/' + searchInput + '/0',
                        type: 'get',
                        success: function(data) {
                            $('#member_table_data').html(data);
                            $.LoadingOverlay("hide");
            ...
            function loadMoreSearchEqubs(searchInput, offsetVal, pageNumberVal) {
                if (searchInput != "") {
                    $.ajax({
                        url: "<?php echo e(url('member/search-equb')); ?>" + '/' + searchInput + '/' +
                            offsetVal + '/' +
                            pageNumberVal,
                        type: 'get',
                        success: function(data) {
            ...
            function clearSearchEntry() {
                ...
                $.ajax({
                    url: "<?php echo e(url('member/clearSearchEntry')); ?>",
                    type: 'get',
                    success: function(data) {
                        $('#member_table_data').html(data);
                        $.LoadingOverlay("hide");
            ...
            function members(offsetVal, pageNumberVal) {
                $.LoadingOverlay("show");
                $.ajax({
                    url: "<?php echo e(url('member/member')); ?>" + '/' + offsetVal + '/' + pageNumberVal,
                    type: 'get',
                    success: function(data) {
                        $('#member_table_data').html(data);
                        $.LoadingOverlay("hide");
            ...
            function validateForm() {
                ...
                $.ajax({
                    url: "<?php echo e(url('member/equb-lottery-detail')); ?>" + '/' + lottery_date,
                    type: 'get',
            ...
            function statusChange(item) {
                ...
                $('#updateStatus').attr('action', "<?php echo e(url('member/updateStatus')); ?>" + '/' + $('#member_id').val());
            }
            ...
            function getCredit() {
                ...
                $.ajax({
                    url: "<?php echo e(url('/getDailyPaidAmount')); ?>" + '/' + equb_id,
                    type: 'get',
                    success: function(data) {
                        daily_amount = data;
            ...
            $(function() {
                ...
                $('#mem').addClass('active');
                $.ajax({
                    url: "<?php echo e(url('member/member')); ?>" + '/' + 0 + '/' + 1,
                    type: 'get',
                    success: function(data) {
                        $('#member_table_data').html(data);
                        $.LoadingOverlay("hide");
                ...
                $('#updateEqub').validate({
                    ...
                    rules: {
                        equb_type_id: {
                            ...
                            maxlength: 30,
                            remote: {
                                url: '<?php echo e(url('equbTypeCheckForUpdate')); ?>',
                                headers: {
                        ...
                        lottery_date: {
                            required: true,
                            remote: {
                                url: '<?php echo e(url('lotteryDateCheckForUpdate')); ?>',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                },
                                type: "post",
                ...
                $('#addEqub').validate({
                    ...
                    rules: {
                        equb_type_id: {
                            ...
                            maxlength: 30,
                            remote: {
                                url: '<?php echo e(url('equbTypeCheck')); ?>',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                },
                                type: "post",
                        ...
                        lottery_date: {
                            required: true,
                            remote: {
                                url: '<?php echo e(url('lotteryDateCheck')); ?>',
                                headers: {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                },
                                type: "post",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\virtual Equb\virtual-backend\resources\views/admin/member/memberList.blade.php ENDPATH**/ ?>