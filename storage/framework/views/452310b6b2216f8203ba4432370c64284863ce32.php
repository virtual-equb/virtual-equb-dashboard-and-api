        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form role="form" method="post" class="form-horizontal form-group nn"
                    action="<?php echo e(route('registerEqub')); ?>" enctype="multipart/form-data" id="addEqub">
                                ...
                                <select class="form-control select2"id="equb_type_id" name="equb_type_id"
                                    ...
                                    <?php $__currentLoopData = $equbTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equbType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option data-info="<?php echo e($equbType->type); ?>"
                                            ...
                                            data-enddate="<?php echo e($equbType->end_date); ?>" data-rote="<?php echo e($equbType->rote); ?>" data-quota="<?php echo e($equbType->quota); ?>"
