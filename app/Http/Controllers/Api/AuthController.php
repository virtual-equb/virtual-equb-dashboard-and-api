...
class AuthController extends Controller
{
    ...
    {
        $this->middleware('auth:api', ['except' => ['login', 'loginTelebirrMiniApp', 'loginCbeBirrMiniApp']]);
    }
    /**
    ...
    public function loginCbeBirrMiniApp(Request $request)
    {
        Log::info('Login Request from - CbeBirr MiniApp', $request->all());
