                                         ...
                                         <ul class='dropdown-menu p-4'>
                                             <li>
                                                 <button href="javascript:void(0);"
                                                     ...
                                                     onclick="{{ $item->status == 'Active' ? 'openEqubAddModal(' . $item . ')' : 'return false;' }}"><i
                                             ...
                                             <li>
                                                 <button href="javascript:void(0);"
                                                     class="text-secondary btn btn-flat {{ $item->status == 'Deactive' ? 'disabled' : '' }}"
                                                     onclick="{{ $item->status == 'Active' ? 'openEditModal(' . $item . ')' : 'return false;' }}"
                                                     ><span
                                             ...
                                             <li>
                                                 <a href="javascript:void(0);" class="text-secondary btn btn-flat"
                                                     onclick="{{ $item->status == 'Active' ? 'statusChange(' . $item . ')' : 'return false;' }}"
                         ...
                         <ul class="pagination">
                             ...
                             @else
                                 <li class="page-item">
                                     <a class="page-link" href="javascript:void(0);"
                                         onclick="loadMoreSearchEqubs('{{ $searchInput }}',{{ $offset - $limit }},{{ $pageNumber - 1 }})"
                                         aria-label="Previous">
                                         <span aria-hidden="true">&laquo;</span>
                                         <span class="sr-only">Previous</span>
                                     </a>
                             ...
                             @if ($pageNumber > 3)
                                 <li class="page-item"><a class="page-link" href="javascript:void(0);"
                                         onclick="loadMoreSearchEqubs('{{ $searchInput }}',{{ $offset - $limit * 3 }},{{ $pageNumber - 3 }})">{{ $pageNumber - 3 }}</a>
                                 </li>
                             @endif
                             @if ($pageNumber > 2)
                                 <li class="page-item"><a class="page-link" href="javascript:void(0);"
                                         onclick="loadMoreSearchEqubs('{{ $searchInput }}',{{ $offset - $limit * 2 }},{{ $pageNumber - 2 }})">{{ $pageNumber - 2 }}</a>
                                 </li>
                             @endif
                             @if ($pageNumber > 1)
                                 <li class="page-item"><a class="page-link" href="javascript:void(0);"
                                         onclick="loadMoreSearchEqubs('{{ $searchInput }}',{{ $offset - $limit }},{{ $pageNumber - 1 }})">{{ $pageNumber - 1 }}</a>
                                 </li>
                             @endif
