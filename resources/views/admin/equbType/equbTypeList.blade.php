...
@extends('layouts.app')
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="small-box bg-success">
                                    <div class="inner">
                                        <h3>{{ $totalActiveEqubType }}</h3>
                                        <p>Active Equb Type</p>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-pie-graph"></i>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                <div class="small-box bg-warning">
                                    <div class="inner">
                                        <h3>{{ $totalInactiveEqubType }}</h3>
                                        <p>Inactive Equb Type</p>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-pie-graph"></i>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h5>Equb Type
                                            <button type="button" class="btn btn-primary float-right" id="register" data-toggle="modal" data-target="#myModal" "> <span class="fa fa-plus-circle"> </span> Add </button>
                                            <button type="button" class="btn btn-primary float-right" id="draw" data-toggle="modal" data-target="#drawModal" style="margin-right: 20px;"> <span class="fa fa-random"> </span> Draw Todays Winner</button>
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive" id="equb_type_table_data">
                                            <table id="equbType-list-table" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($equbTypes as $index => $item)
                                                        <tr>
    ...
    $(function() {
        ...
        }).buttons().container().appendTo('#equb_type_table_data .col-md-6:eq(0)')
