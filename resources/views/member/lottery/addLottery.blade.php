            ...
            <div class="modal-dialog">
              <div class="modal-content">
               <form role="form" method="post" class="form-horizontal form-group"
                      action="{{ route('registerEqubTaker') }}"
                      enctype="multipart/form-data" id="addLottery">
                      {{ csrf_field() }}
                      ...
                      <div class="col-sm-12">
                        ...
                        <input type="hidden" id='equb_lottery_id' name="lottery_equb_id" value="">
                          <div class="form-group required" id="addGender">
                              ...
                              <select class="form-control select2" id="payment_type" name="payment_type" placeholder="payment type" autocomplete="off" required>
                        ...
                        <div class="form-group required">
                            ...
                            <input type="number" class="form-control" id="lottery_amount" name="amount"placeholder="Amount" required>
                        </div>
                        <div class="form-group required">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="number" class="form-control" id="cheque_amount" name="cheque_amount"placeholder="cheque amount">
                        </div>
                        <div class="form-group ">
                            <label class="control-label">Cheque Bank Name</label>
                            <input type="text" class="form-control" id="cheque_bank_name" name="cheque_bank_name"placeholder="cheque bank name">
                        </div>
                          <div class="form-group">
